    ...
    <div className="min-h-screen bg-[#0a0a0a] luxury-texture noise-texture overflow-x-hidden scrollbar-hide scroll-smooth">
      ...
      <section id="hero" className="relative pt-0 md:pt-0 pb-0 overflow-hidden bg-black min-h-screen md:min-h-[140vh] flex items-start md:items-end pb-8 md:pb-12">
        <div className="absolute inset-0">
          ...
          {/* Left image */}
          <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-[15%] w-[22%] h-[50%] z-4 group animate-slide-in-from-left" style={{transform: `translateY(${scrollY * 0.15}px)`, animationDelay: '0.3s', opacity: 0}}>
      ...
      {/* VIP Photo Section - Independent */}
      <section className="relative -mt-[500px] md:-mt-[700px] lg:-mt-[800px] pb-32 md:pb-48 bg-transparent pointer-events-none">
        <div className="relative w-full h-[600px] md:h-[800px] lg:h-[900px]">
          {/* Center VIP Image */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[280px] md:w-[400px] lg:w-[450px] h-[500px] md:h-[700px] lg:h-[800px] z-50 group animate-fade-in-gentle pointer-events-auto" style={{animationDelay: '0.6s', opacity: 0}}>
            <div className="relative w-full h-full">
