        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-[15%] sm:top-[12%] lg:top-[10%] left-0 right-0 mx-6 sm:mx-8 lg:w-[32%] lg:mx-auto lg:left-0 lg:right-0 h-[40%] sm:h-[50%] lg:h-[60%] z-20 group animate-center-reveal" style={{transform: `translateY(${scrollY * 0.1}px)`}}>
            <div className="relative w-full h-full">
              ...
              <div className="absolute top-0 bottom-0 left-0 w-1/3 bg-gradient-to-r from-black/90 via-black/40 to-transparent rounded-3xl z-30 pointer-events-none"></div>
              <div className="absolute top-0 bottom-0 right-0 w-1/3 bg-gradient-to-l from-black/90 via-black/40 to-transparent rounded-3xl z-30 pointer-events-none"></div>
