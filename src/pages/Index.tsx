      ...
      <section id="hero" className={`relative pt-0 md:pt-0 pb-0 overflow-hidden bg-black min-h-screen md:min-h-[140vh] flex items-start md:items-end pb-8 md:pb-12`}>
        <div className="absolute inset-0 overflow-hidden">
          ...
          {heroContent.image_right && (
            <div className="hidden md:block absolute right-[8%] top-0 w-[26%] h-full opacity-40">
              <img 
        ...
        <div className="w-full text-center px-4 md:px-8 relative z-30 pt-[35vh] md:pt-0">
          ...
          <p className="text-white/80 mb-10 leading-relaxed" style={{fontSize: 'clamp(1rem, 2vw, 1.5rem)'}}>
            {heroContent.tagline}
          </p>
          <p className="text-white/70 mb-16 max-w-3xl mx-auto leading-relaxed" style={{fontSize: 'clamp(0.875rem, 1.5vw, 1.125rem)'}}>
            {heroContent.description}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12 w-full mx-auto">
            <div className="bg-[#1a1a1a]/60 border border-[#d4af37]/20 p-4 md:p-8 rounded-xl md:rounded-2xl relative overflow-hidden">
