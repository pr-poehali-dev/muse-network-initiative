        ...
        <div className="container mx-auto">
          ...
          <div className="absolute bottom-4 right-4 md:bottom-8 md:right-8">
            <a 
              ...
              className="flex items-center gap-3 text-2xl text-white/50 hover:text-white/80 transition-colors group"
            >
              <span>Разработано в</span>
              <img 
                src="https://cdn.poehali.dev/files/46b11caa-15ea-48bb-92d0-24b03075a538.png" 
                alt="Albe" 
                className="h-14 opacity-50 group-hover:opacity-80 transition-opacity"
              />
            </a>
          </div>
        </div>
