...
const Index = () => {
  ...
  return (
    <PageTransition>
      ...
      <section className="relative py-12 md:py-16 px-4 bg-black">
            ...
            <div className="group relative bg-gradient-to-br from-[#0a0a0a]/90 to-black/90 rounded-xl border border-[#d4af37]/30 overflow-hidden hover:border-[#d4af37]/60 transition-all duration-500">
              <div className="flex flex-col md:flex-row gap-4 p-4">
                ...
                <div className="flex-1 flex flex-col">
                  <div className="mb-3">
                    <div className="inline-block px-3 py-1 bg-[#d4af37]/20 border border-[#d4af37]/40 rounded-full mb-2">
                      <span className="text-[#d4af37] font-bold text-sm">28.11.2025</span>
                    </div>
                    <h3 className="text-lg md:text-xl font-black text-[#d4af37] mb-1">Самсонова Юлия Аркадьевна</h3>
                    <p className="text-white/60 text-xs mb-1">Стилист / Имиджмейкер</p>
                    <p className="text-white/70 text-xs leading-relaxed mb-2">Как найти свой стиль и интегрировать его в повседневный гардероб</p>
                    <div className="flex items-center gap-2 text-white/50 text-xs mb-3">
                      <Icon name="MapPin" className="w-3 h-3 text-[#d4af37]" />
                  ...
                  <Button
                    onClick={() => {
                      setEventFormData({ ...eventFormData, event: 'Самсонова Юлия Аркадьевна - 28.11.2025' });
                      setIsEventDialogOpen(true);
            ...
            <div className="group relative bg-gradient-to-br from-[#0a0a0a]/90 to-black/90 rounded-xl border border-[#d4af37]/30 overflow-hidden hover:border-[#d4af37]/60 transition-all duration-500">
              <div className="flex flex-col md:flex-row gap-4 p-4">
                ...
                <div className="flex-1 flex flex-col">
                  <div className="mb-3">
                    <div className="inline-block px-3 py-1 bg-[#d4af37]/20 border border-[#d4af37]/40 rounded-full mb-2">
                      <span className="text-[#d4af37] font-bold text-sm">19.12.2025</span>
                    </div>
                    <h3 className="text-lg md:text-xl font-black text-[#d4af37] mb-1">Сивая Ольга Владимировна</h3>
                    <p className="text-white/60 text-xs mb-1">Психолог / Психотерапевт</p>
                    <p className="text-white/70 text-xs leading-relaxed mb-2">Психологический разбор фильма Дракула</p>
                    <div className="flex items-center gap-2 text-white/50 text-xs mb-3">
                      <Icon name="MapPin" className="w-3 h-3 text-[#d4af37]" />
                      <span>ZOOM 18:00</span>
                    </div>
                  ...
                  <Button
                    onClick={() => {
                      setEventFormData({ ...eventFormData, event: 'Сивая Ольга Владимировна - 19.12.2025' });
                      setIsEventDialogOpen(true);
                      scrollToSection('calendar');
                    }}
                    className="mt-auto w-full bg-transparent border-2 border-[#d4af37] text-[#d4af37] hover:bg-[#d4af37]/10 font-semibold text-sm py-3 rounded-none transition-all duration-300"
