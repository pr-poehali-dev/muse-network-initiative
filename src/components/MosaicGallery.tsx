      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
        {images.map((image, index) => (
          <div
            ...
            className="relative overflow-hidden rounded-lg border border-[#b8953d]/20 aspect-square transition-all duration-500 cursor-pointer group hover:scale-105 hover:z-10 hover:shadow-2xl hover:shadow-[#b8953d]/20"
          >
            <img
              src={image.url}
              alt={image.alt}
