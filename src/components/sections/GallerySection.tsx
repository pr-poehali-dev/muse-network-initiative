    ...
    <section id="gallery" className={`relative py-32 px-8 transition-all duration-1000 ${visibleSections.has('gallery') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-br from-[#8b7355]/90 via-[#b8953d]/80 to-[#6b5d42]/90 premium-title">
            Галерея
          </h2>
