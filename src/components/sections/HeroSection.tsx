    ...
    <section id="hero" className={`relative pt-0 md:pt-0 pb-0 overflow-hidden bg-black min-h-screen md:min-h-[140vh] flex items-start md:items-end pb-8 md:pb-12`}>
      ...
      <div className="w-full text-center px-4 md:px-8 relative z-30 pt-[35vh] md:pt-0">
        ...
        >
          ...
          >
            {isMobile ? (
              <span style={{backgroundImage: 'linear-gradient(to right, #b8953d, #8b7355, #6b5d42)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent'}} className="inline-block">
                {heroContent.title}
              </span>
            ) : hoveredLetter ? (
              <span className={`inline-block uppercase transition-all duration-700 ease-in-out ${isTransitioning || isEntering ? 'opacity-0 scale-95 translate-y-2' : 'opacity-100 scale-100 translate-y-0'}`} style={{backgroundImage: 'linear-gradient(to right, #b8953d, #8b7355, #6b5d42)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent', filter: 'drop-shadow(0 0 20px rgba(212,175,55,0.3)) drop-shadow(0 0 40px rgba(184,149,61,0.2)) drop-shadow(2px 4px 8px rgba(0,0,0,0.4))'}}>
              ...
              <span style={{backgroundImage: 'linear-gradient(to right, #b8953d, #8b7355, #6b5d42)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent', filter: 'drop-shadow(0 0 20px rgba(212,175,55,0.3)) drop-shadow(0 0 40px rgba(184,149,61,0.2)) drop-shadow(2px 4px 8px rgba(0,0,0,0.4))', textShadow: '0 0 60px rgba(212,175,55,0.15), 0 0 30px rgba(184,149,61,0.1)'}} className="inline-block">
