...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        event_data = {
            'id': 1,
            'title': 'Мастер-класс по медитации и йоге',
            'date': '2025-12-06',
            'time': '19:00',
            'description': 'Приглашаем на вечерний мастер-класс по медитации и йоге. Практика включает дыхательные упражнения, асаны и медитацию.',
            'type': 'workshop',
            'location': 'Студия MUSE, ул. Рубинштейна 15',
            'seats': 20,
            'speakers': [
                {
                    'name': 'Анна Петрова',
